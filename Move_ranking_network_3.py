# -*- coding: utf-8 -*-
"""
Created on Fri Apr 25 01:44:06 2025
...
def prepare_dataset(file_path):
    ...
    print("Position count:",len(boards))
    return boards, legal_moves_list, best_move_indices

# Training loop
def train_model(data_file, epochs=1):
    ...
    for epoch in range(epochs):
        ...
        torch.save(model,f"moveranking_model_8_epoch{epoch}.pt")
    return model
